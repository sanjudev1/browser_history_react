...
class BrowserHistory extends Component {
  ...
  deletedItem = id => {
    ...
    const deletedList = searchedHistory.filter(eachItem => eachItem.id !== id)
  ...
  render() {
    ...
    const filteredHistory = searchedHistory.filter(eachItem =>
      eachItem.title.toLowerCase().includes(searchResult.toLowerCase()),
    )
